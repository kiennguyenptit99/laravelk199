...
class ProductSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $products = [
            ...
            ['id' => 5, 'name' => 'Áo nữ sơ mi chấm bi xanh', 'code' => 'AN0031', 'slug' => 'ao-nu-so-mi-cham-bi-xanh', 'price' => 350000, 'featured' => 1, 'state' => 1, 'info' => 'Áo nữ sơ mi chấm bi xanh', 'describer' => 'Áo nữ sơ mi chấm bi xanh', 'image' => 'ao-nu-so-mi-cham-bi.jpg', 'categories_id' => 3],
            ...
            ['id' => 20, 'name' => 'Áo nữ sơ mi chấm bi trắng', 'code' => 'AN0034', 'slug' => 'ao-nu-so-mi-cham-bi-trang', 'price' => 350000, 'featured' => 1, 'state' => 1, 'info' => 'Áo nữ sơ mi chấm bi trắng', 'describer' => 'Áo nữ sơ mi chấm bi trắng', 'image' => 'ao-nu-so-mi-cham-bi.jpg', 'categories_id' => 3],
        ];
